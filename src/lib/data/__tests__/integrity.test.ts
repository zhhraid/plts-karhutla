...
function makeRaw(overrides: Partial<RawSite> = {}): RawSite {
  return {
    ...
    coverage_profile: "criticality+resilience+social",
    global_rank_eligible: false,
    karhutla_structural_proxy: 73.21,
    karhutla_low_area_ha: 7652.88,
    karhutla_medium_area_ha: 47596.14,
    karhutla_high_area_ha: 62135.37,
    karhutla_total_area_ha: 117384.39,
    sources: [],
    ...overrides,
  };
}
